...
#[no_mangle]
pub unsafe extern "C" fn A_join(mut A1: A_OBJECT, mut A2: A_OBJECT) -> A_OBJECT {
    ...
    A2 = A_min(A2);
    A = A_create();
    (*A).A_nT = (*A1).A_nT + (*A2).A_nT - 1 as libc::c_int;
    U = U_create();
    if U_insert(U, 0 as libc::c_int, 0 as libc::c_int, 1 as libc::c_int)
        != 0 as libc::c_int
    {
        Error(
            b"A_join: BOTCH 1\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        );
    }
    ...
    {
        Error(
            b"A_join: BOTCH 2\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        );
    }
